...
import { increaseID } from '../../store/main';
...
class AppContainer extends Component {
  ...
  render() {
    return (
      <div>
        <GeneralHeader sidebarStatus={this.state.sidebarStatus} sidebarHandleOnClick={this.sidebarHandleOnClick} />
        <MainContent
          sectionId="main"
...
const AppContainerStore = connect(mapStateToProps, mapDispatchToProps)(AppContainer);
