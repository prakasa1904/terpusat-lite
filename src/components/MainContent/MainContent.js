  ...
  sectionOne = () => (
    <aside id="s-user-alerts" className="sidebar">
      <ul className="tab-nav tn-justified tn-icon m-t-10" data-tab-color="teal">
        <li>
          <a className="sua-messages" href="#sua-messages" data-toggle="tab">
            <i className="zmdi zmdi-email" />
          </a>
        </li>
        <li>
          <a className="sua-notifications" href="#sua-notifications" data-toggle="tab">
            <i className="zmdi zmdi-notifications" />
          </a>
        </li>
        <li>
          <a className="sua-tasks" href="#sua-tasks" data-toggle="tab">
      ...
      <div className="tab-content">
        <div className="tab-pane fade" id="sua-messages">
          <ul className="sua-menu list-inline list-unstyled palette-Light-Blue bg">
            <li>
              <a href="">
                <i className="zmdi zmdi-check-all" /> Mark all
              </a>
            </li>
            <li>
              <a href="">
                <i className="zmdi zmdi-long-arrow-tab" /> View all
              </a>
            </li>
            <li>
              <a href="" data-ma-action="sidebar-close">
                <i className="zmdi zmdi-close" /> Close
              </a>
            </li>
          </ul>
          ...
          <div className="list-group lg-alt c-overflow">
            <a href="" className="list-group-item media">
              ...
              <div className="media-body">
                ...
                <small className="lgi-text">
                  Sorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam mattis lobortis sapien non posuere
                </small>
              </div>
            </a>
            ...
            <a href="" className="list-group-item media">
              ...
              <div className="media-body">
                ...
                <small className="lgi-text">
                  Quisque non tortor ultricies, posuere elit id, lacinia purus curabitur.
                </small>
              </div>
            </a>
            ...
            <a href="" className="list-group-item media">
              ...
              <div className="media-body">
                ...
                <small className="lgi-text">
                  Donec congue tempus ligula, varius hendrerit mi hendrerit sit amet. Duis ac quam sit amet leo feugiat
                  iaculis
                </small>
              </div>
            </a>
            ...
            <a href="" className="list-group-item media">
              ...
              <div className="media-body">
                ...
                <small className="lgi-text">
                  Duis tincidunt augue nec sem dignissim scelerisque. Vestibulum rhoncus sapien sed nulla aliquam
                  lacinia
                </small>
              </div>
            </a>
            ...
            <a href="" className="list-group-item media">
              ...
              <div className="media-body">
                ...
                <small className="lgi-text">
                  Phasellus a ullamcorper lectus, sit amet viverra quam. In luctus tortor vel nulla pharetra bibendum
                </small>
              </div>
            </a>
          </div>
        ...
        <div className="tab-pane fade" id="sua-notifications">
          <ul className="sua-menu list-inline list-unstyled palette-Orange bg">
            <li>
              <a href="">
                <i className="zmdi zmdi-volume-off" /> Mute
              </a>
            </li>
            <li>
              <a href="">
        ...
        <div className="tab-pane fade" id="sua-tasks">
          <ul className="sua-menu list-inline list-unstyled palette-Green-400 bg">
            <li>
              <a href="">
                <i className="zmdi zmdi-time" /> Archived
              </a>
            </li>
            <li>
              <a href="">
  ...
  sectionTwo = () => (
    <aside id="s-main-menu" className={`sidebar ${this.props.sidebarStatus}`}>
      <div className="smm-header">
        <i className="zmdi zmdi-long-arrow-left" onClick={this.sidebarHandleOnClick} />
      </div>
      ...
      <ul className="main-menu">
        <li className="active">
          <a href="index.html">
            <i className="zmdi zmdi-home" /> Beranda
          </a>
        </li>
        <li>
          <a href="" data-ma-action="submenu-toggle">
            <i className="zmdi zmdi-view-compact" /> Wall
          </a>
        </li>
        <li>
          <a href="" data-ma-action="submenu-toggle">
            <i className="zmdi zmdi-collection-text" /> Kontak
          </a>
        </li>
        <li>
          <a href="" data-ma-action="submenu-toggle">
            <i className="zmdi zmdi-image" />Media
          </a>
        </li>
        <li>
          <a href="calendar.html">
            <i className="zmdi zmdi-calendar" /> Calendar
          </a>
        </li>
        <li className="sub-menu">
          <a href="" data-ma-action="submenu-toggle">
            <i className="zmdi zmdi-menu" /> Lainnya
          </a>
          <ul>
            <li>
              <a href="form-elements.html">Level 2 link</a>
            </li>
            <li>
              <a href="form-components.html">Another level 2 Link</a>
            </li>
            <li className="sub-menu">
              <a href="" data-ma-action="submenu-toggle">
                I have children too
            ...
            <li>
              <a href="form-validations.html">One more 2</a>
            </li>
          </ul>
        </li>
      </ul>
            ...
            <h2>
              ...
              <div style={style}>
                <ImageHolder
                  item={{
                    title: 'Kitten 1',
                    image: 'https://placeholdit.imgix.net/~text?txtsize=56&txt=600%C3%97400&w=600&h=400',
                  }}
                />
              </div>
              ...
              <div style={style}>
                <ImageHolder
                  item={{
                    title: 'Kitten 2',
                    image: 'https://placeholdit.imgix.net/~text?txtsize=56&txt=Sialan&w=600&h=400',
                  }}
                />
              </div>
              ...
              <div style={style}>
                <ImageHolder
                  item={{
                    title: 'Kitten 3',
                    image: 'https://placeholdit.imgix.net/~text?txtsize=56&txt=Dicabik&w=600&h=400',
                  }}
                />
              </div>
              ...
              <div style={style}>
                <ImageHolder
                  item={{
                    title: 'Kitten 4',
                    image: 'https://placeholdit.imgix.net/~text?txtsize=56&txt=kadhaskdhsa&w=600&h=400',
                  }}
                />
              </div>
            </h2>
